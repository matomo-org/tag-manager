...
class TagManager extends \Piwik\Plugin
{
    ...
    public function getClientSideTranslationKeys(&$result)
    {
        ...
        $result[] = 'TagManager_TagNameHelpTextV2';
        ...
        $result[] = 'TagManager_TagDescriptionHelpText';
        $result[] = 'TagManager_TriggerDescriptionHelpText';
        $result[] = 'TagManager_VariableDescriptionHelpText';
