...
class TriggerUpdated extends TriggerBaseActivity
{
    protected $eventName = 'API.TagManager.updateContainerTrigger.end';
    ...
    public function getTranslatedDescription($activityData, $performingUser)
    {
        ...
        $desc = sprintf('updated the trigger "%1$s" in container "%2$s" for site "%3$s"', $entityName, $containerName, $siteName);
