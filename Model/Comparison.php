...
class Comparison
{
    ...
    {
        $comparisons = array(
            ['id' => self::ID_EQUALS, 'name' => Piwik::translate('TagManager_ComparisonEquals')],
            ['id' => self::ID_EQUALS_EXACTLY, 'name' => Piwik::translate('TagManager_ComparisonEqualsExactly')],
            ['id' => self::ID_CONTAINS, 'name' => Piwik::translate('TagManager_ComparisonContains')],
            ['id' => self::ID_STARTS_WITH, 'name' => Piwik::translate('TagManager_ComparisonStartsWith')],
            ['id' => self::ID_ENDS_WITH, 'name' => Piwik::translate('TagManager_ComparisonEndsWith')],
            ['id' => 'lower_than', 'name' => Piwik::translate('TagManager_ComparisonLowerThan')],
            ['id' => 'lower_than_or_equals', 'name' => Piwik::translate('TagManager_ComparisonLowerThanOrEqual')],
            ['id' => 'greater_than', 'name' => Piwik::translate('TagManager_ComparisonGreaterThan')],
