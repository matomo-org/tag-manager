    ...
    public function getParameters()
    {
        return array(
            $this->makeSetting('customHtml', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                ...
                $field->inlineHelp = Piwik::translate('TagManager_CustomHtmlTagHelpText', ['<a href="' . Url::addCampaignParametersToMatomoLink('https://matomo.org/faq/tag-manager/faq_26815/') . '">', '</a>']);
